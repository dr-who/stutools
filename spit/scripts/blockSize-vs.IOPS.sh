...
#echo "set xrange auto" > out.gnuplot
#echo "set yrange auto" >> out.gnuplot
...
echo "set title 'spit: IOPS Test'" >> out.gnuplot
echo "set log x" >> out.gnuplot
echo "set xtics 2" >> out.gnuplot
