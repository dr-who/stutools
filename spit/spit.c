	     ...
	     const size_t verify, size_t ramBytesForPositions, size_t defaultqd, size_t showdate)
{
  ...
  size_t blockSize1[] = {8192, 4 * 1024, 3 * 1024, 4,       2048, 1024, 512, 128, 256, 128, 64, 32, 8, 16, 8, 4, 4};
  size_t blockSize2[] = {8192, 4 * 1024, 3 * 1024, 3 * 1024,2048, 1024, 512,512, 256, 128, 64, 32, 64, 16, 8, 8, 4};
