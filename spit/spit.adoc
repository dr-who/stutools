 ...
 *M options*::
   Output MySQL options. (e.g. -M os=centos,version=1.2.59,machine=wow,blockdevice=lsiraid,iotype=write,opsize=64,iopattern=rand,qd=128,devicestate=burst,degraded=0,k=10,m=2,encryption=none,checksum=crc32c)
