...
This package contains the CLI version of spit and spitchecker.
 ...
 *J N*::
   Similar to lowercase *j*, but with uppercase *J* the range will be the same for all threads. Allows cache test and other conflict resolution.
