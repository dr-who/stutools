...
void jobRunThreads(jobType *job, const int num, const size_t minSizeInBytes, const size_t maxSizeInBytes, const size_t timetorun, const size_t dumpPos, char *benchmarkName, const size_t origqd, unsigned short seed, const int savePositions, diskStatType *d);
