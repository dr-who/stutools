...
void jobRunThreads(jobType *job, const int num, char *filePrefix,
                   ...
                   char *mysqloptions, char *mysqloptions2, char *commandstring, char* numaBinding, const int performDiscard, resultType *result, size_t ramBytesForPositions, size_t notexclusive, const size_t showdate, FILE *loadpos);
