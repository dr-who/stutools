...
void positionContainerSave(const positionContainer *p, FILE *name, const size_t bdSizeBytes, const size_t flushEvery,
                           jobType *job);
...
void
positionStats(const positionType *positions, const size_t num, const deviceDetails *devList, const size_t devCount);
