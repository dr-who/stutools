FROM almalinux
MAINTAINER Stu
RUN yum -y install cmake libaio-devel pciutils-devel numactl-devel readline-devel git gcc gcc-c++ make iproute emacs-nox libuuid-devel man man-pages nc jq gdb tmux httpd-tools
